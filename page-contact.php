 ...
 * 
 * 
 * This is a template for the Contact page
 * 
*/
?>
        ...
        <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?> role="article" itemscope itemtype="https://schema.org/BlogPosting">
                ...
                <section id="contact" class="contact-form" itemprop="contactForm">
                    ...
                    <div class="text">
                    <h1 class="page-title" itemprop="headline"><?php the_field('contact_title') ?></h1>
                ...
                <section id="other" class="other" itemprop="contactDetails">
                    ...
                    <div class="social">
                        ...
                        <p>                    
                            ...
                            <a href="<?php the_field('social_instagram'); ?>" class="instagram">Instagram</a>
                        </p>
                        ...
                        <p>
                            ...
                            <a href="<?php the_field('social_facebook'); ?>" class="facebook">Facebook</a>  
                        </p>
                    ...
                    <div class="updates">
                        ...
                        <h5>INNER CIRCLE</h5>
                        <div class="text"><?php the_field('updates_text'); ?></div>
                        <div class="form"><?php the_field('updates_form_shortcode'); ?></div>
